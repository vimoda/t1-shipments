...
class ShipmentRequest(BaseModel):
    ...
    origin_first_name: str = Field(..., description="Sender's first name.", min_length=3, max_length=25)
    origin_last_name: str = Field(..., description="Sender's last name(s).", min_length=3, max_length=25)
    ...
    origin_references: str = Field(..., description="Sender's address references.", min_length=3, max_length=35)
    ...
    destination_references: str = Field(..., description="Recipient's address references.", min_length=3, max_length=35)
